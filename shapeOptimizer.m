function [wireframe_collection, defv_collection, rotation_collection, translation_collection, lambdas_collection] = shapeOptimizer(seq, frm, id)
...
%     fprintf(fileID, "%f\n", lambdas');
    ...
    fclose(fileID);
    cd ceres ;
    system(" singleViewShapeAdjuster.exe");
    cd ../ ;
    ...
    lambdas_collection = [lambdas_collection; l];
    dv = importdata("ceres/vvals.txt");
    defv_collection = [defv_collection; dv];
